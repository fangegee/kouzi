<template>
  <div class="post-list">
    <div class="post-list-box" v-for="(item,index) in newPostList" :key="index">
      <!-- 头像名称 -->
    ...
    <infinite-loading @infinite="newPostinfiniteHandler" ref="infiniteLoading"></infinite-loading>
  </div>
</template>
<script>
